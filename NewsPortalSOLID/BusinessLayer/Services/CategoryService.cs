...
namespace BusinessLayer.Services
{
    public class CategoryService
    {
        ...
        public static CategoryModel Add(CategoryModel obj)
        {
            var CatMod = new Category { CategoryName = obj.CategoryName };
            var cat = FactoryDataAccess.CategoryDataAccess().Add(CatMod);
            var c = new CategoryModel() { CategoryId = cat.CategoryId, CategoryName = cat.CategoryName };
            return c;
