...
namespace NewsPortalAPI.Controllers
{
    public class CategoryController : ApiController
    {
        ...
        [Route("api/category/addcategory")]//coustom routing
        [HttpPost] //Bind for Get only
        public HttpResponseMessage AddCategory(CategoryModel obj)
        {
            var cat = BusinessLayer.Services.CategoryService.Add(obj);
